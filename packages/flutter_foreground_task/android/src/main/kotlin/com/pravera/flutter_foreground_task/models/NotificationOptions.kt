...
data class NotificationOptions(
    ...
    companion object {
        fun getData(context: Context): NotificationOptions {
            ...
            val dismissible = prefs.getBoolean(PrefsKey.DISMISSIBLE, false)
        ...
        fun setData(context: Context, map: Map<*, *>?) {
            ...
            val dismissible = map?.get(PrefsKey.DISMISSIBLE) as? Boolean ?: false
            ...
            with(prefs.edit()) {
                ...
                putBoolean(PrefsKey.DISMISSIBLE, dismissible)
                commit()
            }
        }
