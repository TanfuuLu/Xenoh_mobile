...
class FlutterForegroundTask {
  ...
  /// Opens Android's settings page for a specific notification channel.
  static Future<bool> openNotificationChannelSettings(String channelId) =>
      _platform.openNotificationChannelSettings(channelId);
